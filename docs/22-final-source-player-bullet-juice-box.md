...
The complete `player_bullet_juice_box.gd` file after **every** bullet step is done.
...
### [← Final Source — `bat_juice_box.gd`](21-final-source-bat-juice-box.md) | [Table of Contents](00-contents.md) | [Final Source — `level_juice_box.gd` →](23-final-source-level-juice-box.md)
