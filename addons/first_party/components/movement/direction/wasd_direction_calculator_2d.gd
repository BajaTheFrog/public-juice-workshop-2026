...
@export var movement_freedom: MovementFreedom

@export var maintain_last_direction: bool = false
@export var has_instant_direction_change: bool = true
@export var direction_blacklist: Array = []
